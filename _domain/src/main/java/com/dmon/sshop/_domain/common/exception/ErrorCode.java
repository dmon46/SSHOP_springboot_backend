...
public enum ErrorCode {
    ...
    SYSTEM__ENUM_KEY_INVALID(1003, "Enum key is unsupported.", HttpStatus.INTERNAL_SERVER_ERROR),
    ...
    CART__QUANTITY_MIN(2001, "The quantity should be at least 0.", HttpStatus.BAD_REQUEST),
