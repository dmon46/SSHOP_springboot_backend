...
//
//    /**
//     * - Super classes: AccessDomainService, AccountDomainService: define contract applying Sub classes
//     * - Sub classes: UserDomainService, SellerDomainService: implement Super classes
...
//        if (role.equals(Account.RoleType.USER))
//            throw new AppException(ErrorCode.SYSTEM__DEVELOPING_FEATURE);
