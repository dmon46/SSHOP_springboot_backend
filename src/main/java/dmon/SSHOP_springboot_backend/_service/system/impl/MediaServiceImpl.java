...
public class MediaServiceImpl implements IMediaService {
    ...
    private void validateFile(MultipartFile file) {
        ...
        if (file == null || file.isEmpty())
            throw new AppException(ExceptionCode.MEDIA__FILE_EMPTY);
        ...
        if (!isInExt)
            throw new AppException(ExceptionCode.MEDIA__FILE_OUT_EXTENSIONS);
    ...
    private void createDirectory(String folder) {
        ...
        try {
            ...
            throw new AppException(ExceptionCode.MEDIA__FILE_CREATE_FOLDER);
        }
        ...
        if (!tempDir.isDirectory()) {
            try {
                ...
                throw new AppException(ExceptionCode.MEDIA__FILE_CREATE_DIRECTORY);
            }
        } else
    ...
    private String storeFile(MultipartFile file, String folder) {
        ...
        try {
            ...
            throw new AppException(ExceptionCode.MEDIA__FILE_CREATE_PATH);
        }
        ...
        try (InputStream inputStream = file.getInputStream()) {
            ...
            throw new AppException(ExceptionCode.MEDIA__FILE_STREAM);
        }
        return fileName;
