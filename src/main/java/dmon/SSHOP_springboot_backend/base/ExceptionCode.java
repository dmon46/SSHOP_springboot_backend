...
public enum ExceptionCode {
    ...
    SYSTEM__DEVELOPING_EXCEPTION(1001, "The feature is still developing.", HttpStatus.INTERNAL_SERVER_ERROR),
    SYSTEM__ENUM_KEY_INVALID(1002, "Enum key is invalid.", HttpStatus.INTERNAL_SERVER_ERROR),
    SYSTEM__METHOD_NOT_SUPPORTED(1003, "Method '%s' is not supported.", HttpStatus.INTERNAL_SERVER_ERROR),
    SYSTEM__ROUTE_NOT_SUPPORTED(1004, "Route '%s' not supported.", HttpStatus.INTERNAL_SERVER_ERROR),
    //ACCOUNT 1100+//
    ...
    ACCESS__LOGIN_FAILED(1202, "Username or password doesn't match any our records. Please try again.", HttpStatus.BAD_REQUEST),
    ACCESS__USER_NOT_REGISTER_SELLER(1503, "The account is a user. Please sign up with user account.", HttpStatus.BAD_REQUEST),
    ACCESS__SELLER_NOT_REGISTER_SELLER(1504, "The account already exists. Please choose a different one.", HttpStatus.BAD_REQUEST),
    ACCESS__ADMIN_NOT_REGISTER_SELLER(1515, "The account is banned from registration as seller.", HttpStatus.BAD_REQUEST),
    ACCESS__NOT_IN_SECURITY_CONTEXT(1515, "The account's session is invalid. Please login again.", HttpStatus.BAD_REQUEST),
    //USER 1300+//
    //SELLER 1400+//
    //CATEGORY 1500+//
